...
export class WebSocketService {
  ...
  /**
   * Add a socket room to a user's room subscriptions
   */
  addToRoom(userSocketRoom: string, roomId: string) {
    this.io.in(userSocketRoom).socketsJoin(roomId);
  }

  /**
   * Remove a socket room from a user's room subscriptions
   */
  removeFromRoom(userSocketRoom: string, roomId: string) {
    this.io.in(userSocketRoom).socketsLeave(roomId);
  }
} 